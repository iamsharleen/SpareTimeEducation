...
$.Jcrop = function(obj,opt)
{
	...
	function startDragMode(mode,pos)/*{{{*/
	{
		...
		//Tracker.activateHandlers(select,doneSelect);
	};
	/*}}}*/
...
//		            html += '					<div class="upload_btn">开始上传</div>';
		            html += '				</div>';
		            html += '			</div>';
		            var previewHeight = (parseInt(para.itemHeight)+30)+'px';
		            html += '			<div id="preview" class="upload_preview" style="width:100%;height:'+previewHeight+';">';
				    html += '				<div class="add_upload" style="display:none;">';
